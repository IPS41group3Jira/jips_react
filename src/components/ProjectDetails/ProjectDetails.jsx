        ...
        <>
            <div className='project-details-block'>
                ...
                <div className='project-text project-info'>
                    ...
                    at all levels. Task and Issue Tracking: It simplifies the creation, assignment, and tracking of
                    tasks,
                    issues, and user stories, providing comprehensive visibility into project progress. Agile
                    Methodology
                    Support: APMS accommodates Scrum, Kanban, and other agile methodologies, allowing teams to manage
                    projects
                    according to their unique workflow. Customizable Workflows: Tailor workflows to match your team's
                    specific
                    processes, ensuring flexibility and efficiency in project execution. Integration Capabilities: APMS
                    seamlessly integrates with popular development tools, version control systems, and communication
                    platforms,
